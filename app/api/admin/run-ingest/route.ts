...
export async function POST() {
  ...
  // QA-audit fix: this was labeled "Admin-only" in its own doc comment but
  // only actually checked that *some* company user was logged in - any
  // customer could trigger a real ingest run against the shared platform-
  // wide sourcing pipeline. Now enforces the real admin allowlist.
